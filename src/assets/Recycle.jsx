...
import { GoEarth, handleLogin } from "../utilis";
    ...
    <div>
      ...
      <div className="d-flex justify-content-between">
        ...
        <button
          ...
          data-bs-toggle={!localStorage.getItem("email") ? "" : "modal"}
          data-bs-target={!localStorage.getItem("email") ? "" : `#addWaste`}
        >
          Add to recycle
        </button>
      </div>
      ...
      >
        {collectionData.length > 0 ? (
                                  ...
                                  <form>
                                    ...
                                    <div className="form-group">
                                      ...
                                      <input
                                        ...
                                        required="required"
                                        value={
                                          collectionDetails.productCategory
                                        }
                                        onChange={(e) =>
                                          editCollectionData(
                                            e.target.value,
          ...
          <>
            <div className="p-3 ">Add items to recycle</div>
          </>
        )}
      </div>
    </div>
